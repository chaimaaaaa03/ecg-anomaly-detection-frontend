...
export default function NavBarPatient() {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        const res = await fetch("https://ecg-anomaly-detection-backend-3.onrender.com/api/me", {
            ...
            <DrawerContent>
              ...
              <div className="px-4 flex flex-col gap-6 mt-8">
                <div className="flex flex-row gap-2">
                  ...
                  <Link className="nav-link" href="/patients" style={{ fontSize: "20px" }}>
                    Patients
                  </Link>
                </div>
                ...
                <div className="flex flex-row gap-2">
                  ...
                  <Link className="nav-link" href="/ecg_records" style={{ fontSize: "20px" }}>
                    ECG Records
                  </Link>
                </div>
              </div>

              <div className="flex items-center ml-4 mt-80 gap-2">
                {user && (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <div className="cursor-pointer flex items-center gap-2">
